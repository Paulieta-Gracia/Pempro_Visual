 ...
 * @author Windows
 */
public class requestRestock extends javax.swing.JFrame {
Connection conn = null;
Statement stmt = null;
PreparedStatement pst = null;
ResultSet  rs = null;
    /**
     * Creates new form requestRestock
     */
    public requestRestock() {
        initComponents();
        showClientReq();
        scaleImage();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(requestRestock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new requestRestock().setVisible(true);
            }
        });
    }
